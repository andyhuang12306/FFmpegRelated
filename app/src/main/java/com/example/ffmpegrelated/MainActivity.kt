...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val permissions: ArrayList<String> = arrayListOf(android.Manifest.permission.READ_EXTERNAL_STORAGE,
    ...
    private fun testFile() {
        ...
        val f = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).absolutePath+"/100ANDRO/MOV_0008.mp4")
        if(f.exists()){
